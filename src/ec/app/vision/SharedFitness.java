...
public class SharedFitness extends Fitness
    {
    ...
    /**
     * This stores the number of points each pixel is awarded at the end of an evaluation.
     */
    public double[][] pixelFitness;

    /**
     * This variable replaces hits in the original implementation. It stands for the number of TP + TN.
     */
    public int score;
    
    public boolean compareToOther(final SharedFitness _fitness)
    {
    return _fitness.score < score;
    }
    ...
    */
    ...
    public void setToMeanOf(EvolutionState state, Fitness[] fitnesses)
        ...
        for(int i = 0; i < fitnesses.length; i++)
            {
            SharedFitness fit = (SharedFitness)(fitnesses[i]);
